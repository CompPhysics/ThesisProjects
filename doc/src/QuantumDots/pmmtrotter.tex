...
\begin{center}
{\Large \textbf{Master Thesis Project Proposal}}\\[6pt]
...
Trotter or Suzuki--Trotter decompositions of the time-evolution operator
$U(t) = e^{-iHt}$.  
While higher-order decompositions reduce the Trotter error, they also
increase the circuit depth and thereby make real-device execution more
demanding.  
...
PMMs can emulate eigenvalues, observables, and even unitary evolution,
and show excellent extrapolation properties.  
In particular, PMMs have been shown to reproduce ``zero-error'' Trotter
extrapolations from data taken at moderate time steps.  

This thesis will explore PMMs as a framework for learning
effective Hamiltonians corresponding to different Trotter expansions.
The goal is to test whether PMMs can systematically reduce Trotter
errors, learn Trotterized unitaries, and predict ideal time evolution
from noisy quantum hardware.  
The project will involve both classical simulations and experiments on
real quantum computers (IBM Quantum, AWS Braket, or Azure Quantum).
