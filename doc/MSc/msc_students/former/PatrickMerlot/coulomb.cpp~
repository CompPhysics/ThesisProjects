...
// does NOT compute <12|V|34>as, just the exchange term of it
// Be careful, this function doesn't account for spin. Should be multiplied by \delta(ms1,ms4) * \delta(ms2,ms3) in order to get the correct value for the single element
//
