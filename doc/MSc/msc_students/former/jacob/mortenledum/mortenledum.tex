...
\section*{Master thesis project for Morten Ledum: Multiscale physics}
...
\item Fall 2016:  The next step is to include a proper treatment of quantum mechanical effects by performing variational Monte Carlo calculations to determine better correlations.
