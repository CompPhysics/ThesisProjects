...
FiniteHarmonicOscillator::FiniteHarmonicOscillator(System *system, double distToWall, double alpha, double omega, bool analyticalKinetic, bool repulsion)
...
double FiniteHarmonicOscillator::evaluateSingleParticleWF(vec n, std::vector<double> r, int j) {
...
std::vector<double> FiniteHarmonicOscillator::computeSPWFDerivative(vec n, std::vector<double> r, int j) {
...
double FiniteHarmonicOscillator::computeSPWFDoubleDerivative(vec n, std::vector<double> r, int j) {
...
double FiniteHarmonicOscillator::computeSPWFAlphaDerivative(vec n, std::vector<double> r, int j) {
...
double FiniteHarmonicOscillator::computeHermitePolynomial(int nValue, double position) {
...
double FiniteHarmonicOscillator::computeHermitePolynomialDerivative(int nValue, double position) {
...
double FiniteHarmonicOscillator::computeHermitePolynomialDoubleDerivative(int nValue, double position) {
...
double FiniteHarmonicOscillator::computeHermitePolynomialAlphaDerivative(int nValue, double position) {
