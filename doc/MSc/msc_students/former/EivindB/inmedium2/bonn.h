...
c
      ...
      subroutine obpara
c
c        obpara reads, writes and stores the parameters for the
...
19000 format (/////' error in obpara:  meson-group   ',a4,'   does not
     1 exist in this program.'/' execution terminated.'////)
      go to 9999
c
c
 9001 write (kwrite,19001)
19001 format (/////' error in obpara: too many mesons within a meson-g
...
19002 format (/////' error in obpara: cut-off type',f10.4,' does not e
     1xist in this program.'/' execution terminated.'////)
      go to 9999
c
c
 9003 write (kwrite,19003) iftyp
19003 format (/////' error in obpara: factor type has the non-permissi
     1ble value',i4,' .'/' execution terminated.'////)
      go to 9999
c
c
 9004 write (kwrite,19004) cc(4)
19004 format (/////' error in obpara: isospin has the non-permissible
     1value',f10.4,'  .'/' execution terminated.'////)
      go to 9999
c
c
 9005 write (kwrite,19005) cc(5)
19005 format (/////' error in obpara:     iprop has the non-permissibl
     1e value',f10.4,'  .'/' execution terminated.'////)
      go to 9999
c
c
 9006 write (kwrite,19006) cc(2)
19006 format (/////' error in obpara: the index for the denominator of
...
19009 format (/////' error in obpara: the exponent of the cut-off is l
     1ess than zero.'/' execution terminated.'////)
      go to 9999
c
c
 9010 write (kwrite,19010)
19010 format (/////' error in obpara: too many cut-off parameters with
     1 respect to the given'/' dimensions. execution terminated.'////)
      go to 9999
c
c
 9011 write (kwrite,19011)
19011 format (/////' error in obpara:  too many mesons with respect to
...
c
      ...
      subroutine obaia
c
c        obaia performs the numerical integration over angle theta
...
c
   95 nt=nt+j
c
c        compute nt, which is suitable for gseta
c
...
c
 2000 return
      ...
      subroutine legpa (pj,pjm1,x,j)
c
c
c        subroutine legpa   computes the legendre polynominals
c
...
c
  100 zn=n
      write(kwrite,200) zn
  200 format(/////' error in gseta. n has the non-permissible value',
