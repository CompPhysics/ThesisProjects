...
! value is y = P(x). 
      ...
      DOUBLE PRECISION :: den ,dif, dift, ho, hp, w, x, y, dy
...
!     The trapezoidal rule is used
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: trapez_sum
      DOUBLE PRECISION fa, fb, x, step
      INTEGER :: j
      INTERFACE
...
!     Simpson's method is used
      ...
      DOUBLE PRECISION, INTENT(IN) :: a,b
      DOUBLE PRECISION, INTENT(INOUT) :: simpson_sum
      DOUBLE PRECISION fa, fb, x, step, fac
      INTEGER, INTENT(IN) :: n 
      INTEGER :: j
...
!
      ...
      IMPLICIT NONE
      INTEGER :: n
      DOUBLE PRECISION, DIMENSION(n) :: yt, dyt, dym
      DOUBLE PRECISION, DIMENSION(n), INTENT(IN) :: y, dydx
      DOUBLE PRECISION, DIMENSION(n), INTENT(OUT) :: yout
      DOUBLE PRECISION :: hh, h6, xh, step
      DOUBLE PRECISION, INTENT(IN) :: x 
...
!
        DOUBLE PRECISION FUNCTION rtnewt(funcd,x1,x2,xacc)
        IMPLICIT NONE
        INTEGER :: jmax, j
