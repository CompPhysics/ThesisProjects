                ...
                if self.schema[i][e] != None:
                    ...
                    if self.T[i].q_c[e] == 1:
                        ...
                        if coupled < 0:
                            ...
                            coupled = abs(coupled) - 1
                            v_out.append(self.H_labels_a[coupled])
                            
                        if coupled > 0:
                            #passing through interaction
                            coupled = abs(coupled) - 1
                            v_out.append(self.H_labels_c[coupled])
                    ...
                    if self.T[i].q_c[e] == -1:
                        ...
                        if coupled < 0:
                            #reflecting at interaction
                            coupled = abs(coupled) - 1
                            v_ins.append(self.H_labels_a[coupled])
                            
                        if coupled > 0:
                            #passing through interaction
                            coupled = abs(coupled) - 1
                            v_ins.append(self.H_labels_c[coupled]) 
