...
c
c       NOTE: the tbibdc contained in this package is
c             the in-medium version.
c             to see the differences to the free version,
c             search for `NOTE' in tbibdc.
c             medium effects from Delta come out correct only
c             for iprop=2.
c             10/19/02
c
...
c
c
      parameter (inx1=33,iimex=13,inr=32,inr1=inr+1)
c
...
c
c**** NOTE: the wn that has just been read-in, is ignored !!!!
c**** instead, the effective mass provided by the t-matrix
c     program is used; see next line:
c
      wn=wsnspp
c
c
...
c                                                                       00003590
      ...
      q(i)= tan(qaa)*cqi + qfmev                                        00003620
...
c                                                                       00007560
 ...
 1210 do 1225 il=1,imed                                                 00007640
      ...
      if ( abs(vj(ii,iil)).lt.1.d-20) vj(ii,iil)=0.d0                   00007670
...
c                                                                       00007770
 ...
 1310 do 1325 il=1,imedd                                                00007850
      ...
      if ( abs(vj(ii,iil)).lt.1.d-20) vj(ii,iil)=0.d0                   00007880
...
c                                                                       00009470
c                                                                       00009480
c        antisymmetrise :                                               00009490
c        cases of sing and coup                                         00009500
c                                                                       00009510
c                                                                       00009520
...
c                                                                       00009570
      fb=-1.d0                                                          00009580
 2212 do 2213 ii=1,4                                                    00009590
      ii3=8+ii                                                          00009600
      ii4=17-ii                                                         00009610
      vil(ii3)=(vil(ii3)+fb*vil(ii4))*0.5d0                             00009620
      vill(ii3)=(vill(ii3)+fb*vill(ii4))*0.5d0                          00009630
      vil(ii4)=vil(ii3)*fb                                              00009640
 2213 vill(ii4)=vill(ii3)*fb                                            00009650
c                                                                       00009660
c                                                                       00009670
      if(fb.eq.1.d0) go to 2223                                         00009680
c                                                                       00009690
c                                                                       00009700
c        sum over discrete intermediate states,                         00009710
c        cases of sing and coup                                         00009720
c                                                                       00009730
...
c                                                                       00009870
c                                                                       00009880
c        antisymmetrise :                                               00009890
c        case of trip                                                   00009900
c                                                                       00009910
c                                                                       00009920
      do 2221 ii=9,16                                                   00009930
      vil(ii)=vvnd(ii+ixx1,il)                                          00009940
 2221 vill(ii)=vvnd(ii+iyy1,ill)                                        00009950
c                                                                       00009960
c                                                                       00009970
      fb=1.d0                                                           00009980
      go to 2212                                                        00009990
c                                                                       00010000
c                                                                       00010010
c        sum over discrete intermediate states,                         00010020
c        case of trip                                                   00010030
c                                                                       00010040
 2223 do 2225 ii=1,4                                                    00010050
      ii2=8+ii                                                          00010060
      ii5=17-ii                                                         00010070
 2225 cvv(2)=cvv(2)+(vil(ii2)+vil(ii5))*(vill(ii2)+vill(ii5))           00010080
c                                                                       00010090
c                                                                       00010100
...
c
c
      parameter (inr=32,inr1=inr+1,iimex=13)
      parameter (irsdd=2*inr1*iimex)
c
c                                                                       00000160
...
c                                                                       00000770
      ...
      mcd=1                                                             00000800
c                                                                       00000810
c**** NOTE: the following statement is changed as compared
c****       to the original version of this program
c****       that was made for free space scattering
c
      wnnn=wnn(inter) 
c
c**** NOTE: wn is to taken from common /ctbsc/, i.e.
c****       the one provided by tmatc through tbibdc.
c
c
c**** NOTE: the following statement is disabled on purpose:
c**** the wd provided by tbibdc throught the common block
c**** /ctbsc/ is to be used.
c**** wd=wdd(inter)                                                     00000830
c
c
      wnq=wn*wn                                                         00000840
      wdq=wd*wd                                                         00000850
c                                                                       00000860
c**** NOTE: dwn and dwnq are only used to scale the same way
c****       as obas; in obas all masses and momenta are
c****       devided by the free nucleon mass.
c
      dwn=1.d0/wnnn                                                     00000870
...
c
c**** NOTE: the following statement is changed as compared to the
c****       free space version
c
      wds=wn*wd*dwnq                                                    00000910
c                                                                       00000920
      wpi=wpx                                                           00000930
...
c                                                                       00001870
 1200 iret=1                                                            00001880
      ...
      omq=omq+dwnq*smp(-deltak(i,1)*wnq,qfmev,ispm)
      om=dsqrt(omq)                                                     00001920
      omkq=c4-deltak(i,iret)                                            00001930
      omkq=omkq+dwnq*smp(-deltak(i,iret)*wnq,qfmev,ispm)
