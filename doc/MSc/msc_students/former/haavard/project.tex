...
\section*{Thesis title: Monte Carlo and density functional theory studies of atoms}
...
The functional will in turn be used to parameterize a semi-classical potential
to be used in quantum-molecular dynamical studies of properties of materials. 
...
mechanical density.  The density will be used to construct a density functional for atoms
using the adiabatic-connection method as described by Teale {\em et al} in J.~Chem.~Phys.~{\bf 130},
104111 (2009).  The results will be compared with existing density functional for various atoms
and used in studies of materials with atoms like silisium.


\section*{Progress plan and milestones}
The aims and progress plan of this thesis are as follows
\begin{itemize}
\item Fall 2009: Develop first a Hartree-Fock code for electrons in atoms.  
...
density functional for atoms 
using the adiabatic-connection method. The density functional can in turn be used to model
systems with a large number of atoms. Possible applications are to mechanical studies of materials.
\end{itemize}
