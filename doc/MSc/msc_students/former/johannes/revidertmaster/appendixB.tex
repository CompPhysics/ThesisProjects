...
\eeq\\
\\
Let us now multiply \sd \bra{Elm}\sd\ with \sd \ket{\bold k}\sd,
\beq
\begin{split}
...
(H_0-E)\ket{Elm}=0,
\eeq
and by doing the same on the eigenbra \sd \bra{\bold k}\sd we obtain
\beq
\bra{\bold k}(H_0-E)=\bra{\bold k}\left(\frac{ k^2}{2m}-E\right).
\eeq
Multplying \sd\ket{Elm}\sd\, from the right gives zero,
\beq
