...
It is not easy to give a short presentation on the area of quantum mechanics, it is a rather huge and strange subject. When speaking about quantum mechanics we should always keep in mind what Feynman said, "I think it is safe to say that no one understands Quantum Mechanics". 
...
between the definition of light as a wave and as a particle.  Light has
...
maxima's the net result of the waves will be a peak with twice the amplitude of
the waves, which is an example of constructive interference. If the waves are
completely out of phase when they meet, one of the waves are phasing upwards
