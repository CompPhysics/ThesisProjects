...
\include{chapter3}
\clearemptydoublepage
\include{chapter4} % vlowk.tex
\clearemptydoublepage
\include{chapter5} % nuclear structure, mass, and nuclear matter
\clearemptydoublepage
\include{chapter6} % vlowk.tex
\clearemptydoublepage
\include{chapter7} % coupled.tex
\clearemptydoublepage
%\part{Implementation}
\include{chapter8} % coupled.tex
\clearemptydoublepage
\include{chapter9} % coupled.tex
\clearemptydoublepage
%\include{interactions} % coupled.tex
