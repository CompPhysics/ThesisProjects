...
c      subroutine av18pw(l,s,j,t,r,vpw)
      implicit real*8 (a-h,o-z)
...
c      vc=vnn(1)+t1dt2*vnn(2)+s1ds2*vnn(3)+s1ds2*t1dt2*vnn(4)
c      vt=vnn(5)+t1dt2*vnn(6)
c      vls=vnn(7)+t1dt2*vnn(8)
c      vl2=vnn(9)+t1dt2*vnn(10)+s1ds2*vnn(11)+s1ds2*t1dt2*vnn(12)
c      vls2=vnn(13)+t1dt2*vnn(14)
