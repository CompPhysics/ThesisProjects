From leinaas@socrates.Berkeley.EDU Mon Jun  9 09:19:06 2003
Date: Sun, 8 Jun 2003 21:36:46 -0700
From: leinaas@socrates.Berkeley.EDU
To: Morten Hjorth-Jensen <morten.hjorth-jensen@fys.uio.no>
Subject: Re: drgradsprogram Eirik

Hei Morten!
Jeg tenker å få ferdig søknadspapirer og sende dem til Eirik i løpet
av et par dager. Har bedt ham ordne med det resterende, egne
eksamenspapirer, bekreftlese om eksamensdato og underskrift fra
instituttet. Jeg sender som vedlegg Latex-filen med prosjekt
beskrivelse. det er fint om du sender meg den tilbake med dine
korreksjoner og tillegg. Det kunne vel ellers være på sin plass med
et anbefalingsbrev fra en av oss, evt begge?
Når det gjelder oppgaven synes jeg han har gjort et godt stykke
arbeid, selv om jeg må innrømme at detaljer når det gjelder
beregninger har jeg liten oversikt over. Det vet du mer om. I
forbindelse med eksamen er det vel naturlig at du formidler ditt/vårt
inntrykk av arbeidet han gjort til sensor og er med på å diskutere
karakteren.
Jeg håper han får en mulighet til å følge det opp med et dr-stipend.
Håper ellers alt står bra til og du ikke er helt overarbeidet i denne
eksamenstid. Når er det forresten du skal ha ditt sabbatsår og hvor
drar du?
Hilsen Jon Magne
...
{Dr. scient. program for Eirik Ouvrum}\\
...
research activity. The interest is in part due to the expectations that
have been created that quantum physics opens new, qualitatively different,
...
information, both on formal side, where algorithms for simulations of quantum
systems will be studied, and on the physical side where the application of
concepts from quantum information theory in the study of many-body systems
will be studied. The first part follows up the cand. scient. thesis of Eirik
Ouvrum on quantum computation. The second part will focus in particular on
...
to study is in what way relative (entanglement) entropy depends on distance and
...
as research
advisors for Eirik under his cand. scient. theses work.) Although the local
...
faculty in addition to a large number of students taking actively
part. It is of
great interest to follow up this activity and to involve students at
the doctoral
level in the activity. We will seek contact with others that are active in the
...
Eirik Ouvrum has written a cand. scient. thesis on {\em Quantum Computing and
...
work gives a good starting point for further research in the field.  Below are
listed some main subjects that the research program will focus on.\\

\noindent
{\em Algorithms for quantum computing}\\
The aim of this part of the program is to extend the study of the algorithm
introdused in  \cite{eirik}, where the method of finding energy
eigenvalues of a
...
simulation of the
quantum measurements. It is of interest to compare the efficience of the
...
\bibitem{eirik} E. Ouvrum, {\em Quantum Computing and Many-Body
Physics}, Thesis
...
\end{document}
    ...
    [ Part 2, Text/PLAIN (Name: "Dr.scient.prosjekt-Eirik")  170 lines. ]
